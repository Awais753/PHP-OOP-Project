...
require_once 'core/init.php';
    ...
    if(Input::exists()){
        if(Librerian::getInstance()->login(Input::get('name'),Input::get('password'))){
      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <?php
            if(Input::exists()){
                ...
                $user = new User;
                if(Validate::adminName($fields['username'])){
                    if(Validate::adminPass($fields['password'])){
                        if($user->login(Input::get('name'),Input::get('password'))){
                            Redirect::to("dashboard.php");
                        }
                    }else{
                        echo Validate::flash("danger", "Incorrect password!");    
                    }
                }else{
                    echo Validate::flash("danger", "Invalid Admin Name");   
                }
            }
